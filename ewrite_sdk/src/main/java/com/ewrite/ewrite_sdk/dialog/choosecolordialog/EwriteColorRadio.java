...
public class EwriteColorRadio extends android.support.v7.widget.AppCompatRadioButton implements ValueAnimator.AnimatorUpdateListener {
    ...
    public EwriteColorRadio(Context context) {
        this(context, null, 0);
    }

    public EwriteColorRadio(Context context, int color) {
        this(context, null, 0);
        this.mColor = color;
    ...
    public EwriteColorRadio(Context context, AttributeSet attrs) {
        super(context, attrs);
        initialize(context, attrs, 0);
    }

    public EwriteColorRadio(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initialize(context, attrs, defStyleAttr);
    }

    private void initialize(Context context, AttributeSet attrs, int defStyleAttr) {
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.EwriteColorRadio);

        mColor = a.getColor(R.styleable.EwriteColorRadio_image_color, Color.BLACK);

        mStrokeColor = a.getColor(R.styleable.EwriteColorRadio_image_stroke_color, Color.WHITE);
