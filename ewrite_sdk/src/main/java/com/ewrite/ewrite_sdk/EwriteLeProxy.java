...
import com.ewrite.ewrite_sdk.event.EwriteGetBlueToothMessage;
...
public class EwriteLeProxy {
    ...
    private static EwriteLeProxy mInstance;

    private BleService mBleService;
    private boolean mEncrypt = false;

    private EwriteLeProxy() {
    }

    public static EwriteLeProxy getInstance() {
        if (mInstance == null) {
            mInstance = new EwriteLeProxy();
        }
        return mInstance;
    }
    ...
    private final BleCallBack mBleCallBack = new BleCallBack() {
        ...
        public void onCharacteristicChanged(String address, BluetoothGattCharacteristic characteristic) {
            ...
            Log.i("zhonghuibin", DataUtil.byteArrayToHex(data));
    ...
    private void updateBroadcast(String address, BluetoothGattCharacteristic characteristic) {
        ...
        EwriteGetBlueToothMessage a = new EwriteGetBlueToothMessage();
        a.setIntent(intent);
